...
Rankings is an e-commerce search engine microservice I built to understand how intelligent product ranking works under the hood. instead of just matching keywords, I wanted to create a system that actually understands what a user is looking for whether it's the "latest" tech or a "budget" deal.
...
Rankings is smarter. It detects these "intent keywords" and changes how it sorts the results:
...
1.  **Clone the repo**
    ```bash
    git clone https://github.com/aavishkark/Rankings.git
    cd Rankings
    ```
